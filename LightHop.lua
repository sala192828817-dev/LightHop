...
local THEME = {
    ...
    Accent = Color3.fromRGB(255, 190, 40),          -- Amarelo vivo principal
    AccentHover = Color3.fromRGB(255, 210, 70),     -- Amarelo mais claro no hover
    ...
    TitleYellow = Color3.fromRGB(255, 200, 50),     -- Amarelo do título
}
